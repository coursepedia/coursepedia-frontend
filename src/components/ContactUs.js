...
export default class ContactUs extends Component {
	...
	handleSubmit(event) {
		...
		emailjs.send("gmail", "template_XXXXXXXX", templateParams, "user_XXXXXXXXXXXXXXXXXXXX");
		this.resetForm();
	}
	resetForm() {
		this.setState({
					...
					<div className="container">
						...
						<div className="row">
							<div className="col-lg-12">
								<form id="contactForm" name="sentMessage" noValidate="noValidate" onSubmit={this.handleSubmit.bind(this)}>
									<div className="row">
